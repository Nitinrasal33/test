...
public static void main(String[] args) throws InterruptedException, IOException {
  ...
  // Locate the file input element.
     ...
     String filePath = "C:\\Users\\ASUS\\eclipse-workspace\\test\\src\\main\\resources\\nitinimage.jpg"; // Replace with the actual path of your image file

     // Send the file path to the file input element
     fileInput.sendKeys(filePath);
     // parametrization
FileInputStream file=new  FileInputStream("C:\\Users\\ASUS\\OneDrive\\Desktop\\jobchange\\qa\\dataforinput.xlsx");
